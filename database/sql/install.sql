...
-- ----------------------------
BEGIN;
INSERT INTO `admin_menu` VALUES (1, 0, 1, '仪表盘', 'fa-bar-chart', '/', NULL, NULL, '2020-04-03 16:08:50');
...
INSERT INTO `admin_menu` VALUES (16, 0, 19, '配置设置', 'fa-gears', NULL, NULL, '2020-04-03 21:32:33', '2020-04-03 23:59:33');
INSERT INTO `admin_menu` VALUES (17, 16, 22, '支付网关', 'fa-bars', '/pays', NULL, '2020-04-03 21:32:48', '2020-04-03 23:59:33');
INSERT INTO `admin_menu` VALUES (18, 16, 21, '邮件模板', 'fa-envelope', '/emailtpls', NULL, '2020-04-03 22:18:12', '2020-04-03 23:59:33');
...
CREATE TABLE `coupons` (
  ...
  `is_status` int(11) NOT NULL DEFAULT '1' COMMENT '是否已经使用 1正常 2已使用',
  `card` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '优惠码内容',
...
CREATE TABLE `orders` (
  ...
  `coupon_id` int(100) DEFAULT '0' COMMENT '优惠码',
  `ord_class` int(1) NOT NULL DEFAULT '1' COMMENT '1自动发货 2人工发货',
  ...
  `account` varchar(200) NOT NULL COMMENT '订单邮箱',
  `ord_info` text NOT NULL COMMENT '订单详情',
  `pay_ord` varchar(200) DEFAULT NULL COMMENT '第三方支付 ID',
  `pay_way` int(20) DEFAULT NULL COMMENT '第三方支付方式',
  `buy_ip` varchar(30) DEFAULT NULL COMMENT '客户 IP 地址',
  `ord_status` int(1) DEFAULT '1' COMMENT '1待处理 2已处理 3已完成 4已失败',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `pays` VALUES (2, '支付宝 PC', 'aliweb', 'dump', '商户号', '', '密钥', '/pay/alipay', 1, '2019-07-08 13:25:27', '2019-07-12 09:47:53');
INSERT INTO `pays` VALUES (3, '码支付 QQ', 'mqq', 'dump', '商户号', '', '密钥', '/pay/mapay', 1, '2019-07-11 09:05:27', '2019-07-11 12:13:11');
...
INSERT INTO `pays` VALUES (6, 'Paysapi 支付宝', 'pszfb', 'dump', '商户号', '', '密钥', '/pay/paysapi', 1, '2019-07-11 09:31:12', '2019-07-11 09:31:12');
INSERT INTO `pays` VALUES (7, 'Paysapi 微信', 'pswx', 'dump', '商户号', '', '密钥', '/pay/paysapi', 1, '2019-07-11 09:31:43', '2019-07-11 09:31:43');
INSERT INTO `pays` VALUES (8, '微信扫码', 'wescan', 'scan', '商户号', '', '密钥', '/pay/wepay', 1, '2019-07-12 07:50:20', '2019-07-12 08:08:26');
INSERT INTO `pays` VALUES (11, 'Payjs 微信扫码', 'payjswescan', 'dump', '商户号', '', '密钥', '/pay/payjs', 1, '2019-07-25 07:28:42', '2019-08-20 12:17:58');
...
INSERT INTO `pays` VALUES (16, '易支付-QQ 钱包', 'qqpay', 'dump', '商户号', NULL, '密钥', '/pay/yipay', 1, '2020-07-14 16:27:03', NULL);
...
CREATE TABLE `products` (
  ...
  `pd_type` int(1) NOT NULL DEFAULT '1' COMMENT '1自动发货 2手动发货',
  `other_ipu` text,
